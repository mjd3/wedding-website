        ...
        if (counter >= questions.length) {
            $('#a1, #a2, #a3, #a4, #a5, #question').fadeOut("slow", function () {
                if (right == questions.length){
                    var result = $(`<div id='question' class='field is-size-4'><strong class='has-text-success'>You got all ${right}/${questions.length} right.</strong></br><div class='is-size-5'> Wow! You got them all right! There's no way you're not a stalker. Not that you need it, but scroll down to read the full story!</div></div>`).hide();
                }
                else if (right == questions.length - 1){
                    var result = $(`<div id='question' class='field is-size-4'><strong class='has-text-success'>You got ${right}/${questions.length} right.</strong></br><div class='is-size-5'> Pretty good! You must be quite close to Katie and Mike... or you're a stalker. Scroll down for the full story!</div></div>`).hide();
                }
                    ...
                    var result = $(`<div id='question' class='field is-size-4'><strong class='has-text-danger'>You got ${right}/${questions.length} right.</strong></br><div class='is-size-5'> Wow you did terribly! Do you even know Katie and Mike!? Scroll down and take notes...</div></div>`).hide();
                }
